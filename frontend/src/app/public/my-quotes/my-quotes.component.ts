...
import { QuotationRequest, Message } from '../../core/models/quotation.model';
...
export class MyQuotesComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        const allRequests = await this.quoteService.getRequests();
        this.myRequests = allRequests.filter(r => r.email === this.currentUserEmail);
    }
